...
if ($gameToEdit && $gameToEdit['user_id'] != $_SESSION['user_id'] && ($_SESSION['role'] ?? '') !== 'admin') {
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="../../controllers/game_update.php" method="post">
                            ...
                            <div class="mb-3">
                                <label for="id" class="form-label text-warning">ID hry:</label>
                                <input type="text" id="id" name="id" class="form-control" value="<?= htmlspecialchars($gameToEdit['id']) ?>" readonly>
                            </div>
                            ...
                            <button type="submit" class="btn-submit btn-lg w-100">Uložit změny</button>
                        </form>
                    </div>
                    </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                                ...
                                if ($isAdmin || $ownsGame):
                            ?>
                                <a href="?edit=<?= $game['id'] ?>" class="btn-action btn-primary">Upravit</a>
                                <a href="../../controllers/game_delete.php?id=<?= $game['id'] ?>" class="btn-action btn-danger" onclick="return confirm('Opravdu chcete smazat tuto hru?');">Smazat</a>
                            <?php else: ?>
